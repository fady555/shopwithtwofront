...
export default class Filterizr {
    ...
    private bindEvents;
    /**
     * If it contains img_user it makes use of the imagesloaded npm package
     * to trigger the first render after the img_user have finished loading
     * in the DOM. Otherwise, overlapping can occur if the img_user do not
     * have the height attribute explicitly set on them.
     *
     * In case the grid contains no img_user, then a simple render is performed.
     */
