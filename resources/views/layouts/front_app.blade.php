...
<head>
    ...
    <title>@yield('title_front','no title')</title>
                            ...
                            <li class="menu-item lang-menu menu-item-has-children parent">
                                ...
                                <a title="English" href="#">
                                    <span class="img label-before">
                                        <img src="{{asset('assets/images/'.'lang-'.Config::get('app.locale').'.png')}}" alt="lang-en">
                                    </span>
                                ...
                                <ul class="submenu lang" >
                                    ...
                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        <li class="menu-item" ><a rel="alternate" hreflang="{{ $localeCode }}"  title="hungary" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><span class="img label-before"><img src="{{asset('assets/images/'.'lang-'.$localeCode.'.png')}}" alt="lang-hun"></span>{{ $properties['native'] }}</a></li>
                                    @endforeach
