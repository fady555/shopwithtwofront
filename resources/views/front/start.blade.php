...
<div class="container">
    ...
    <div class="wrap-main-slide">
        <div class="slide-carousel owl-carousel style-nav-1 owl-loaded owl-drag" data-items="1" data-loop="1" data-nav="true" data-dots="false">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2340px, 0px, 0px); transition: all 0s ease 0s; width: 8190px;">
...
{{-----------------------------------------foreach--------------------------------------------------}}
                    ...
                    <div class="owl-item cloned" style="width: 1170px;"><div class="item-slide">
                    ...
                    <div class="owl-item active" style="width: 1170px;"><div class="item-slide">
                ...
                </div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="fa fa-angle-left" aria-hidden="true"></i></button><button type="button" role="presentation" class="owl-next"><i class="fa fa-angle-right" aria-hidden="true"></i></button></div><div class="owl-dots disabled"></div></div>
    </div>
    ...
    <div class="wrap-show-advance-info-box style-1 has-countdown">
        ...
        <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container owl-loaded owl-drag" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive="{&quot;0&quot;:{&quot;items&quot;:&quot;1&quot;},&quot;480&quot;:{&quot;items&quot;:&quot;2&quot;},&quot;768&quot;:{&quot;items&quot;:&quot;3&quot;},&quot;992&quot;:{&quot;items&quot;:&quot;4&quot;},&quot;1200&quot;:{&quot;items&quot;:&quot;5&quot;}}">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1869px;">
                    ...
                    {{---   @foreach(\App\Itm::where('number_of_buy','>','10')->get as $itm)   ---}}
                    @foreach(\App\Itm::all() as $itm)
                        <div class="owl-item active" style="width: 233.6px;">
                            <div class="product product-style-2 equal-elem " style="height: 316px;">
                                ...
                                <div class="product-info">
                                    <a href="#" class="product-name"><span>{{$itm->description}}</span></a>
                                    <div class="wrap-price"><ins><p class="product-price">{{$itm->discount}}</p></ins> <del><p class="product-price">{{$itm->price}}</p></del></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="wrap-products">
            <div class="wrap-product-tab tab-style-1">
                <div class="tab-contents">
                    <div class="tab-content-item active" id="digital_1a" style="height: 336px;">
                        <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container owl-loaded owl-drag" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive="{&quot;0&quot;:{&quot;items&quot;:&quot;1&quot;},&quot;480&quot;:{&quot;items&quot;:&quot;2&quot;},&quot;768&quot;:{&quot;items&quot;:&quot;3&quot;},&quot;992&quot;:{&quot;items&quot;:&quot;4&quot;},&quot;1200&quot;:{&quot;items&quot;:&quot;5&quot;}}">
        ...
        <div class="wrap-products">
            <div class="wrap-product-tab tab-style-1">
                <div class="tab-control">
                    {{---
                    <a href="#" class="tab-control-item active">Smartphone</a>
                    --}}


                    @foreach(\App\Product::all() as $product)
                    <i  class="btn btn-block">
                        <a href="{{route('home',['product_id'=>$product->id])}}">{{$product->name}}</a>
                    </i>
                    @endforeach
                ...
                <div class="tab-contents">
                    ...
                    <div class="tab-content-item active"  style="height: 356px;">
                        <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container owl-loaded owl-drag" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive="{&quot;0&quot;:{&quot;items&quot;:&quot;1&quot;},&quot;480&quot;:{&quot;items&quot;:&quot;2&quot;},&quot;768&quot;:{&quot;items&quot;:&quot;3&quot;},&quot;992&quot;:{&quot;items&quot;:&quot;4&quot;},&quot;1200&quot;:{&quot;items&quot;:&quot;5&quot;}}">
