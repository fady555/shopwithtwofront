                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem " style="height: 386px;">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">$250.00</span> <del> <p class="product-price">$550.00</p> </del> </div>
                        ...
                        <div class="widget-content">
                            <ul class="list-category">
                                ...
                                <li class="category-item has-child-cate">
                                    ...
                                    <ul class="sub-cate">
                                        <li class="category-item"><a href="{{ url()->current() }}" class="cate-link">Batteries (22)</a></li>
                                        <li class="category-item"><a href="{{ url()->current() }}" class="cate-link">Headsets (16)</a></li>
                                        <li class="category-item"><a href="#" class="cate-link">Screen (28)</a></li>
                                    </ul>
                                </li>

                                <li class="category-item">
                                    <a href="{{ url()->current() }}" class="cate-link">Tools &amp; Equipments</a>
                                </li>
